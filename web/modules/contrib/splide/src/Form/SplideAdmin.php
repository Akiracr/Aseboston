...
class SplideAdmin implements SplideAdminInterface {
  ...
  public function fieldableForm(array &$form, array $definition): void {
    ...
    if (isset($form['image'])) {
      ...
      $form['image']['#description'] = $this->t('If Vanilla enabled and Optionset nav is provided, this will be used for thumbnail instead. The actual Main stage will be the rendered entity, not this image.<br>') . $description;
    }
